...
export class PrinterHelper {
  static printer = new PdfPrinter({
    Roboto: {
      normal: path.resolve(__dirname, "../../public/fonts/Roboto-Regular.ttf"),
      bold: path.resolve(__dirname, "../../public/fonts/Roboto-Medium.ttf"),
      italics: path.resolve(__dirname, "../../public/fonts/Roboto-Italic.ttf"),
      bolditalics: path.resolve(__dirname, "../../public/fonts/Roboto-MediumItalic.ttf"),
