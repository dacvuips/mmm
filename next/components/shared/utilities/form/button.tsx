...
export function Button({
  ...
  const finalClassName = `${buttonClass} ${buttonText} ${buttonHover} ${buttonSize} ${props.unfocusable ? "no-focus" : ""
  ...
  const Children = (
    <>
      ...
      {props.text && (
        <span
          className={`relative transform transition-transform ${!props.icon && loading ? "translate-x-2.5" : ""
            }`}
        >
          {!props.icon && loading && (
