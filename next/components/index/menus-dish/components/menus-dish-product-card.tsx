...
import { ProductQuantityButtons } from "../../../shared/product/product-quantity-buttons";
...
export function MenusDishProductCard({
  product,
      ...
      <a className={`block py-3 transition border-gray-100 cursor-pointer hover:text-primary-dark ${className}`}>
        <div className="flex">
          ...
          <div className="flex flex-col justify-start flex-1 pl-3 leading-6 min-h-24">
            <span className="font-semibold products-start text-ellipsis-2 ">{product.name}</span>
            {!!product.rating && (
